...
#define SDC_SSI_RX_PORT_BASE		GPIO_PORTE_BASE
#define SDC_SSI_RX              	GPIO_PIN_5
#define SDC_SSI_TX_PORT_BASE		GPIO_PORTE_BASE
#define SDC_SSI_TX              	GPIO_PIN_4
#define SDC_SSI_FSS_PORT_BASE		GPIO_PORTB_BASE
#define SDC_SSI_FSS             	GPIO_PIN_4
#define SDC_SSI_CLK_PORT_BASE		GPIO_PORTB_BASE
...
void SELECT (void)
{
    ROM_GPIOPinWrite(SDC_SSI_FSS_PORT_BASE, SDC_SSI_FSS, 0);
}
...
void DESELECT (void)
{
    ROM_GPIOPinWrite(SDC_SSI_FSS_PORT_BASE, SDC_SSI_FSS, SDC_SSI_FSS);
}
...
void send_initial_clock_train(void)
{
    ...
    ROM_GPIOPinTypeGPIOOutput(SDC_SSI_TX_PORT_BASE, SDC_SSI_TX);
    ROM_GPIOPinWrite(SDC_SSI_TX_PORT_BASE, SDC_SSI_TX, SDC_SSI_TX);
    ...
    ROM_GPIOPinTypeSSI(SDC_SSI_TX_PORT_BASE, SDC_SSI_TX);
}
